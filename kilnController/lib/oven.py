...
try:
    ...
    if config.max31856:
        from adafruit_max31856 import MAX31856, MAX31856Error
...
class TempSensorReal(TempSensor):
    def __init__(self, time_step):
        ...
        if config.max31856:
            ...
            self.thermocouple = MAX31856(spi, cs)
    ...
    def run(self):
        while True:
            try:
                ...
                # Convert temp value to F.
                print("The temperature is {} degrees F.".format(fahrenheit))
            except Exception:
