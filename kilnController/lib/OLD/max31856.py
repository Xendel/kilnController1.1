...
if __name__ == "__main__":
    ...
    for cs_pin in cs_pins:
        thermocouples.append(MAX31856(cs_pin, clock_pin, data_pin, units))
    running = True
    while(running):
        try:
